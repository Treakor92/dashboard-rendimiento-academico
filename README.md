...
La primera construcción puede tardar varios minutos. Binder instalará las dependencias, ejecutará el archivo `start` en segundo plano y abrirá el proxy del puerto 8050.
